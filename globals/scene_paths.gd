...
const EXPLOSION: PackedScene = preload("uid://d3f70f14ikinm")
const GRENADE: PackedScene = preload("uid://kcho5jn6l33a")
const LASER_HORIZONTAL: PackedScene = preload("uid://csyy7vr5pyr6k")
